...
const columns = [
  ...
  { key: "loanQueryNumber", label: "Loan Query Number", sortable: true },
  ...
  { key: "driverLicenseDocument", label: "Driver License Document" },
  ...
  { key: "timeInThisJob", label: "Time in Current Job" },
  { key: "paidFrequency", label: "Salary Payment Frequency" },
  { key: "takeHomeIncome", label: "Take Home Income" },
  { key: "partnerPaidFrequency", label: "Partner Paid Frequency" },
  { key: "partnerTakeHomeIncome", label: "Partner Take Home Income" },
  { key: "otherIncome", label: "Other Income", sortable: true },
...
const Leads: React.FC = () => {
  const { data, loading, error } = useFetch(endpoints["Loan"].fetchAll);
